...
OUT_PATH="/home/manolotis/sandbox/temporal-consistency-tests/multipathPP/predictions_simplified_rg/"

python $BASE_SCRIPT \
  --config /home/manolotis/sandbox/temporal-consistency-tests/multipathPP/code/configs/predict.yaml \
  --test-data-path "/home/manolotis/sandbox/temporal-consistency-tests/multipathPP/data/prerendered/validation_simplified_rg/" \
